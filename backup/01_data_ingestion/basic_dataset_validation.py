def validate_dataset(df):
    ...
    if "label" in columns:
        ...
        # Use display() in Databricks for better visualization
        if in_databricks:
            try:
    ...
    if "text" in columns:
        ...
        print(f"• Average text length: {length_stats['avg_length']:.2f} characters")
        print(f"• Minimum text length: {length_stats['min_length']} characters")
        print(f"• Maximum text length: {length_stats['max_length']} characters")
